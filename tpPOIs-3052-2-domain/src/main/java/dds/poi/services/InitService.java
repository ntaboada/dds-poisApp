...
public class InitService {
    ...
    public void initEntrega1(){
        ...
        this.parada114 = new POIBuilder().imagen("fa-bus").coordenadas(coordenadaParada).nombre("Parada UTN Campus|Linea 114").direccionPrincipal("Mozart 2300")
        ...
        this.almacenDonManolo = new POIBuilder().imagen("fa-shopping-cart").identificador(2l).coordenadas(coordenadaAlmacen).nombre("Almacén Don Manolo")
    ...
    public void initEntrega3(){
        ...
        this.adminUser = new UserBuilder().id(1l).userName("Admin").mail("admin1@dds.com").password("asd123")
                .profileType(new UserProfileBuilder().action(UserActions.ADMIN_ACTIONS).build()).build();
        this.consultUser = new UserBuilder().id(2l).userName("Usuario1").mail("mail2@dds.com").password("asd123")
        ...
        this.invalidUser = new UserBuilder().id(3l).userName("UsuarioCualka").mail("cualka").password("asd123")
